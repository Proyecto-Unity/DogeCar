...
public class MovimientoAuto : MonoBehaviour {
	...
	void OnGUI(){
		GUI.DrawTexture (new Rect (Screen.width-200, Screen.height -145, 200, 200), Medidor);
		...
		GUI.DrawTexture (new Rect (Screen.width-202, Screen.height -150, 200, 200), Puntero);
	}
}
